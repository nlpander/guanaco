...
def exec_round(model, cfg, prompt, conversation_list, temperature, speaker1, speaker2):
    ...
    prompt, conversation_list = segments.get_new_prompt(output, conversation_list, \
...
def cli_main(
    ...
    for n in tqdm(range(0,rounds)):            
        ...
        if temp_mode == 'none':
            ...
            temperature = temperature.get_temperature_exp_decay(n, baseline_temp, rounds, decay_constant, period)
